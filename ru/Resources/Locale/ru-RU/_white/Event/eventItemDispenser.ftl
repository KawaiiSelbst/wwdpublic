...
event-item-dispenser-examine-infinite-single =
    { $remaining ->
        [1] There's only [color=yellow]one[/color] item inside.
       *[0] It's [color=yellow]empty[/color].
    }
event-item-dispenser-examine-infinite-autodispose-single =
    { $remaining ->
...
event-item-dispenser-examine-infinite-autodispose-manualdispose-single =
    { $remaining ->
...
event-item-dispenser-examine-infinite-manualdispose-single =
    { $remaining ->
        [1] I can only take [color=yellow]one[/color] item here. If I need to, I can return it and get a new one.
...
event-item-dispenser-examine-finite-single =
    { $remaining ->
        [1] There's only [color=yellow]one[/color] item inside.
       *[0] It's [color=yellow]empty[/color].
    }
event-item-dispenser-examine-finite-manualdispose-single =
    { $remaining ->
