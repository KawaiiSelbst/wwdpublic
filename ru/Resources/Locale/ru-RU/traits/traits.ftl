...
trait-description-LightStep = You move with a gentle step, which makes your footsteps quieter.
...
trait-description-ShadowkinBlackeye = You lose your special Shadowkin powers & respect amongst your peers, in return for some points. Effectively, you are only a Shadowkin in name, not in practice.
...
trait-description-MedicalEyesModule = Your Cyber-Eyes have been upgraded to include a built-in Medical Hud, and a Chemical Analysis Hud, allowing you to track the relative health condition of biological organisms, and discern the chemicals in any solution.
